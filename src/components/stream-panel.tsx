      ...
      <div>
        <div className="option-section">
          ...
          <p data-i18n="ui.stream.desc" style="margin-bottom: 10px;">
            Connect to an external program that broadcasts currently played chart and judgement events. For example,
            <a
              href="https://github.com/jack9966qk/TJAAnalyzer/releases/tag/OpenTaikoPatched"
              target="_blank"
              rel="noopener"
            >
