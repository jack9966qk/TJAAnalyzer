...
export class StreamPanel extends HTMLElement {
  ...
  render() {
    ...
    // We don't deal with simulation here anymore except for disabling connect maybe?
    // If simulation is active (from Tester tab), we probably shouldn't allow connecting from here?
