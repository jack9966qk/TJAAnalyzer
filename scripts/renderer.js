...
export function getNoteAt(x, y, chart, canvas, judgements = [], options) {
...
export function renderChart(chart, canvas, judgements = [], judgementDeltas = [], options, texts = DEFAULT_TEXTS, customDpr) {
