const resources = {
    en: {
        ...
        "ui.stream.desc": 'Connect to an external program that broadcasts currently played chart and judgement events. For <a href="https://github.com/0auBSQ/OpenTaiko/releases/tag/0.6.0.95" target="_blank">OpenTaiko v0.6.0.95</a> or above, turn on "Game Event Broadcasting" in settings.',
        "ui.stream.host": "Host:",
        "ui.stream.port": "Port:",
    ...
    zh: {
        ...
        "ui.stream.test": "测试模拟",
        "ui.stream.desc": '连接到广播当前游玩谱面和判定事件的外部程序。对于 <a href="https://github.com/0auBSQ/OpenTaiko/releases/tag/0.6.0.95" target="_blank">OpenTaiko v0.6.0.95</a> 或更高版本，请在设置中开启 "Game Event Broadcasting"。',
        "ui.stream.host": "主机：",
        "ui.stream.port": "端口：",
    ...
    ja: {
        ...
        "ui.stream.desc": '現在プレイ中の譜面や判定イベントをブロードキャストする外部プログラムに接続します。<a href="https://github.com/0auBSQ/OpenTaiko/releases/tag/0.6.0.95" target="_blank">OpenTaiko v0.6.0.95</a> 以上の場合、設定で "Game Event Broadcasting" をオンにしてください。',
        "ui.stream.host": "ホスト:",
        "ui.stream.port": "ポート:",
