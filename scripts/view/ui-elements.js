...
export const optionsCollapseIcon = document.getElementById("options-collapse-icon");
export const optionsPanelHeader = document.getElementById("options-panel-header");
...
export const dsCollapseIcon = document.getElementById("ds-collapse-icon");
export const dsPanelHeader = document.getElementById("ds-panel-header");
...
export const chartListPanel = document.getElementById("chart-list-panel");
