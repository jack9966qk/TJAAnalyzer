import{f as pe,t as ve,N as Ce,e as ue,J as z,L as K,j as be,a as U,b as Ee,g as Se,I as le,h as ye,P as V,i as we,r as _e,k as ce,l as Oe,m as xe}from"./renderer-BNN-Vw3U.js";const Le=o=>pe(o.children);function ee(o){return{bpm:o,scroll:1,measureRatio:1,gogoTime:!1,currentBarBuffer:"",currentBarBpmChanges:[],currentBarScrollChanges:[],currentBarGogoChanges:[]}}function Be(o){const e=o.split(/\r?\n/),t={},s={};let n=null,i=!1;const h={};for(let a of e)if(a=a.trim(),!!a){if(a.startsWith("COURSE:"))n=a.substring(7).trim(),t[n.toLowerCase()]=[],s[n.toLowerCase()]={},i=!1;else if(a.startsWith("#START"))i=!0;else if(a.startsWith("#END"))i=!1,n=null;else if(i&&n){const f=a.indexOf("//");f!==-1&&(a=a.substring(0,f).trim()),a&&t[n.toLowerCase()].push(a)}else if(!i){const f=a.split(":");if(f.length>=2){const l=f[0].trim().toUpperCase(),u=f.slice(1).join(":").trim();n?s[n.toLowerCase()][l]=u:h[l]=u}}}const c={};for(const a in t)if(Object.hasOwn(t,a)){const f=t[a],l={...h,...s[a]},u=l.TITLEJA||l.TITLE||"",b=l.SUBTITLEJA||l.SUBTITLE||"",w=parseFloat(l.BPM)||120,j=parseInt(l.LEVEL,10)||0,W=l.COURSE||a;let se=[];const ne=l.BALLOON;ne&&(se=ne.split(/[,]+/).map(d=>parseInt(d.trim(),10)).filter(d=>!Number.isNaN(d)));const T=[],F=[],N=[],k=[],A=[],I=[],P=ee(w),G=ee(w),D=ee(w),g=(d,v,C,r,L,H=!1,me)=>{let ae=r.bpm,ie=r.scroll,$=r.gogoTime,X=!0;for(const R of d){if(R.startsWith("#")){const y=R.toUpperCase();if(y.startsWith("#BPMCHANGE")){const m=R.split(/[:\s]+/);if(m.length>=2){const p=parseFloat(m[1]);Number.isNaN(p)||(r.bpm=p,r.currentBarBpmChanges.push({index:r.currentBarBuffer.length,bpm:p}))}}else if(y.startsWith("#BPM:")){const m=parseFloat(R.substring(5));Number.isNaN(m)||(r.bpm=m,r.currentBarBpmChanges.push({index:r.currentBarBuffer.length,bpm:m}))}else if(y.startsWith("#SCROLL")){const m=R.split(/[:\s]+/);if(m.length>=2){const p=parseFloat(m[1]);Number.isNaN(p)||(r.scroll=p,r.currentBarScrollChanges.push({index:r.currentBarBuffer.length,scroll:p}))}}else if(y.startsWith("#MEASURE")){const m=R.split(/[:\s]+/);if(m.length>=2){const p=m[1].split("/");if(p.length===2){const oe=parseFloat(p[0]),Q=parseFloat(p[1]);!Number.isNaN(oe)&&!Number.isNaN(Q)&&Q!==0&&(r.measureRatio=oe/Q)}}}else y.startsWith("#GOGOSTART")?(r.gogoTime=!0,r.currentBarGogoChanges.push({index:r.currentBarBuffer.length,isGogo:!0}),r.currentBarBuffer.length===0&&($=!0)):y.startsWith("#GOGOEND")&&(r.gogoTime=!1,r.currentBarGogoChanges.push({index:r.currentBarBuffer.length,isGogo:!1}),r.currentBarBuffer.length===0&&($=!1));continue}let J=R;for(;;){const y=J.indexOf(",");if(y===-1){r.currentBarBuffer+=J;break}else{const m=J.substring(0,y);r.currentBarBuffer+=m;const p=r.currentBarBuffer.trim();p.length===0?v.push([]):v.push(p.split("").map(ve)),C.push({bpm:ae,scroll:ie,measureRatio:r.measureRatio,gogoTime:$,isBranched:L,isBranchStart:L&&H&&X,branchStartParams:L&&H&&X?me:void 0,bpmChanges:r.currentBarBpmChanges.length>0?[...r.currentBarBpmChanges]:void 0,scrollChanges:r.currentBarScrollChanges.length>0?[...r.currentBarScrollChanges]:void 0,gogoChanges:r.currentBarGogoChanges.length>0?[...r.currentBarGogoChanges]:void 0}),X=!1,ae=r.bpm,ie=r.scroll,$=r.gogoTime,r.currentBarBpmChanges=[],r.currentBarScrollChanges=[],r.currentBarGogoChanges=[],r.currentBarBuffer="",J=J.substring(y+1)}}}};let S=[],M=[],_=[],O=[],x=!1,B="n",re=!1,E;for(const d of f){const v=d.toUpperCase().trim();if(v.startsWith("#BRANCHSTART")){re=!0;const C=d.split(/[, \s]+/);if(C.length>=4?E={type:C[1].toLowerCase(),p1:parseFloat(C[2]),p2:parseFloat(C[3])}:E=void 0,S.length>0&&(g(S,T,F,P,!1),g(S,N,k,G,!1),g(S,A,I,D,!1),S=[]),x){const r=M,L=_.length>0?_:r,H=O.length>0?O:L;g(r,T,F,P,!0,!0,E),g(L,N,k,G,!0,!0,E),g(H,A,I,D,!0,!0,E)}x=!0,B="n",M=[],_=[],O=[]}else if(v.startsWith("#BRANCHEND")){const C=M,r=_.length>0?_:C,L=O.length>0?O:r;g(C,T,F,P,!0,!0,E),g(r,N,k,G,!0,!0,E),g(L,A,I,D,!0,!0,E),x=!1,M=[],_=[],O=[]}else x&&v==="#N"?B="n":x&&v==="#E"?B="e":x&&v==="#M"?B="m":x?B==="n"?M.push(d):B==="e"?_.push(d):B==="m"&&O.push(d):S.push(d)}if(x){const d=M,v=_.length>0?_:d,C=O.length>0?O:v;g(d,T,F,P,!0,!0,E),g(v,N,k,G,!0,!0,E),g(C,A,I,D,!0,!0,E)}else S.length>0&&(g(S,T,F,P,!1),g(S,N,k,G,!1),g(S,A,I,D,!1));const Z=(d,v,C)=>({bars:d,barParams:v,loop:Re(d),balloonCounts:se,headers:l,title:u,subtitle:b,bpm:w,level:j,course:W,branchType:C}),q=Z(T,F,"normal");re&&(q.branches={normal:q,expert:Z(N,k,"expert"),master:Z(A,I,"master")}),c[a]=q}return c}function Re(o){let e=-1;for(let s=0;s<o.length;s++)if(!he(o[s])){e=s;break}if(e===-1)return;const t=o.length-e;for(let s=1;s<=t/2;s++){const n=o.slice(e,e+s);let i=0,h=e;for(;h+s<=o.length;){let c=!0;for(let a=0;a<s;a++)if(!Te(o[h+a],n[a])){c=!1;break}if(c)i++,h+=s;else break}if(i>=2){let c=!0;for(let a=h;a<o.length;a++)if(!he(o[a])){c=!1;break}if(c)return{startBarIndex:e,period:s,iterations:i}}}}function he(o){return o.length===0?!0:o.every(e=>e===Ce.None)}function Te(o,e){if(o.length!==e.length)return!1;for(let t=0;t<o.length;t++)if(o[t]!==e[t])return!1;return!0}class Fe{indexUrl="ese_index.json";treeCache=null;async getTjaFiles(){if(this.treeCache)return this.treeCache;try{const e=await fetch(this.indexUrl);if(!e.ok){if(e.status===404)return console.warn("ese_index.json not found. Returning empty list."),[];throw new Error(`Failed to fetch ESE index: ${e.status} ${e.statusText}`)}let t;const s=await e.json();return Array.isArray(s)?t=s:typeof s=="object"&&s!==null&&"files"in s&&Array.isArray(s.files)?t=s.files:t=[],this.treeCache=t,t}catch(e){throw console.error("Error fetching ESE index:",e),new Error("Failed to load song list.")}}async getFileContent(e){try{const s=`ese/${e.split("/").map(encodeURIComponent).join("/")}`,n=await fetch(s);if(!n.ok)throw new Error(`Failed to fetch file: ${n.status} ${n.statusText}`);return await n.text()}catch(t){throw console.error("Error fetching file content:",t),new Error("Failed to load song content.")}}}const de=`//TJADB Project
...
0, //123
#END
`;class Ne{eventSource=null;simulateInterval=null;onMessageCallback=null;onStatusChangeCallback=null;connect(e,t){this.disconnect();const s=`http://${e}:${t}/`;console.log(`Connecting to ${s}...`);try{this.eventSource=new EventSource(s),this.eventSource.onopen=()=>{console.log("Connected to judgement source."),this.onStatusChangeCallback&&this.onStatusChangeCallback("Connected")},this.eventSource.onmessage=n=>{try{const i=JSON.parse(n.data);this.onMessageCallback&&this.onMessageCallback(i)}catch(i){n.data&&n.data.trim()!==""&&console.error("Failed to parse event data",i,n.data)}},this.eventSource.onerror=n=>{console.error("EventSource error."),this.eventSource?.readyState===EventSource.CLOSED?this.onStatusChangeCallback&&this.onStatusChangeCallback("Disconnected"):this.onStatusChangeCallback&&this.onStatusChangeCallback("Error/Reconnecting")}}catch(n){console.error("Connection error:",n),this.onStatusChangeCallback&&this.onStatusChangeCallback("Connection Failed")}}cleanup(){let e=!1;return this.eventSource&&(this.eventSource.close(),this.eventSource=null,e=!0),this.simulateInterval&&(clearInterval(this.simulateInterval),this.simulateInterval=null,e=!0),e}disconnect(){this.cleanup()&&this.onStatusChangeCallback&&this.onStatusChangeCallback("Disconnected")}startSimulation(e,t){this.cleanup(),console.log("Starting simulation..."),this.onStatusChangeCallback&&this.onStatusChangeCallback("Connected");const s=e||de,n=t||"oni";if(this.onMessageCallback){const l={type:"gameplay_start",tjaSummaries:[{player:1,tjaContent:s,difficulty:n}]};this.onMessageCallback(l)}const i=Be(s),h=i[n]||Object.values(i)[0];if(!h){console.error("Simulation failed: Could not parse chart");return}const c=[],a={};for(const l of h.bars)for(const u of l)ue.includes(u)&&(a[u]===void 0&&(a[u]=0),c.push({type:u,ordinal:a[u]}),a[u]++);let f=0;this.simulateInterval=window.setInterval(()=>{if(f>=c.length){this.simulateInterval&&clearInterval(this.simulateInterval);return}const l=c[f];f++;const u=Math.random();let b="perfect";u<.9?b="perfect":u<.99?b="good":b="poor";const w=Math.floor(Math.random()*100)-50,j={type:"judgement",judgement:b,msDelta:w,noteChar:l.type,noteOrdinalByChar:l.ordinal};this.onMessageCallback&&this.onMessageCallback(j)},100+Math.random()*200)}onMessage(e){this.onMessageCallback=e}onStatusChange(e){this.onStatusChangeCallback=e}}const fe="tja_analyzer_profile",Y="tja_analyzer_playdata",te={isTesterMode:!1,playdata:null,defaultViewOptions:null,autoAnnotateOnLoad:!1};function ge(){try{const o=localStorage.getItem(fe),e=localStorage.getItem(Y);let t=null;if(e)try{t=JSON.parse(e)}catch(s){console.error("Failed to parse playdata",s)}if(o){const s=JSON.parse(o);return{...te,...s,playdata:t}}return{...te,playdata:t}}catch(o){console.error("Failed to load user profile",o)}return{...te}}function Me(o){const e=ge(),{playdata:t,...s}={...e,...o};try{localStorage.setItem(fe,JSON.stringify(s)),t!==void 0&&(t===null?localStorage.removeItem(Y):localStorage.setItem(Y,JSON.stringify(t)))}catch(n){console.error("Failed to save user profile",n)}}function je(){try{localStorage.removeItem(Y)}catch(o){console.error("Failed to clear playdata",o)}}const ke={parsedTJACharts:null,currentChart:null,viewOptions:{viewMode:"original",coloringMode:"categorical",visibility:{perfect:!0,good:!0,poor:!0},collapsedLoop:!1,selectedLoopIteration:void 0,beatsPerLine:16,selection:null,annotations:new K,showTextInAnnotationMode:!1,alwaysShowAnnotations:!1,autoZoom:!1},loadedTJAContent:de,activeDataSourceMode:"list",isSimulating:!1,isStreamConnected:!1,hasReceivedGameStart:!1,selectedNoteHitInfo:null,selectedBranchHitInfo:null,annotations:new K,eseClient:new Fe,eseTree:null,judgementClient:new Ne,judgements:new z,currentEsePath:null,currentStatusKey:"status.initializing",currentStatusParams:void 0,isTesterMode:ge().isTesterMode,isNeutralinoConnected:!1,swRegistrationError:null,displayOnlySelected:!1};class Ae extends HTMLElement{canvas;messageContainer;_chart=null;_viewOptions=null;_judgements=new z;_texts;_message=null;resizeObserver;mutationObserver;_renderTask=null;_pendingFullRender=!0;_chartChanged=!1;_layout=null;_renderedJudgements=new z;constructor(){super(),this.attachShadow({mode:"open"}),this.resizeObserver=new ResizeObserver(()=>{this._pendingFullRender=!0,this.scheduleRender()}),this.mutationObserver=new MutationObserver(e=>{for(const t of e)t.type==="attributes"&&t.attributeName==="class"&&(this._pendingFullRender=!0,this.scheduleRender())})}connectedCallback(){this.renderDOM(),this.upgradeProperty("chart"),this.upgradeProperty("viewOptions"),this.upgradeProperty("judgements"),this.upgradeProperty("texts"),this.resizeObserver.observe(this),this.mutationObserver.observe(this,{attributes:!0}),document.addEventListener("fullscreenchange",this.handleFullscreenChange),document.addEventListener("webkitfullscreenchange",this.handleFullscreenChange),this.scheduleRender()}handleFullscreenChange=()=>{this._pendingFullRender=!0,this.scheduleRender()};renderDOM(){const e=be(Le,{children:[U("style",{children:`
            :host {
                display: block;
                width: 100%;
                overflow: hidden;
