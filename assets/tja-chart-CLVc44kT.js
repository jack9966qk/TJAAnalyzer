import{f as he,t as ue,N as de,e as ie,J as U,L as z,j as fe,a as D,b as ge,g as me,I as ne,h as pe,P as W,i as Ce,r as ve,k as re,l as be,m as Ee}from"./renderer-CiiLB4PM.js";const Se=l=>he(l.children);function K(l){return{bpm:l,scroll:1,measureRatio:1,gogoTime:!1,currentBarBuffer:"",currentBarBpmChanges:[],currentBarScrollChanges:[],currentBarGogoChanges:[]}}function we(l){const e=l.split(/\r?\n/),t={},s={};let r=null,i=!1;const c={};for(let a of e)if(a=a.trim(),!!a){if(a.startsWith("COURSE:"))r=a.substring(7).trim(),t[r.toLowerCase()]=[],s[r.toLowerCase()]={},i=!1;else if(a.startsWith("#START"))i=!0;else if(a.startsWith("#END"))i=!1,r=null;else if(i&&r){const u=a.indexOf("//");u!==-1&&(a=a.substring(0,u).trim()),a&&t[r.toLowerCase()].push(a)}else if(!i){const u=a.split(":");if(u.length>=2){const h=u[0].trim().toUpperCase(),f=u.slice(1).join(":").trim();r?s[r.toLowerCase()][h]=f:c[h]=f}}}const o={};for(const a in t)if(Object.hasOwn(t,a)){const u=t[a],h={...c,...s[a]},f=h.TITLEJA||h.TITLE||"",S=h.SUBTITLEJA||h.SUBTITLE||"",B=parseFloat(h.BPM)||120,H=parseInt(h.LEVEL,10)||0,le=h.COURSE||a;let Y=[];const q=h.BALLOON;q&&(Y=q.split(/[,]+/).map(d=>parseInt(d.trim(),10)).filter(d=>!Number.isNaN(d)));const L=[],R=[],T=[],k=[],N=[],A=[],M=K(B),j=K(B),G=K(B),g=(d,C,v,n,I,ce=!1)=>{let Q=n.bpm,ee=n.scroll,J=n.gogoTime,te=!0;for(const O of d){if(O.startsWith("#")){const E=O.toUpperCase();if(E.startsWith("#BPMCHANGE")){const m=O.split(/[:\s]+/);if(m.length>=2){const p=parseFloat(m[1]);Number.isNaN(p)||(n.bpm=p,n.currentBarBpmChanges.push({index:n.currentBarBuffer.length,bpm:p}))}}else if(E.startsWith("#BPM:")){const m=parseFloat(O.substring(5));Number.isNaN(m)||(n.bpm=m,n.currentBarBpmChanges.push({index:n.currentBarBuffer.length,bpm:m}))}else if(E.startsWith("#SCROLL")){const m=O.split(/[:\s]+/);if(m.length>=2){const p=parseFloat(m[1]);Number.isNaN(p)||(n.scroll=p,n.currentBarScrollChanges.push({index:n.currentBarBuffer.length,scroll:p}))}}else if(E.startsWith("#MEASURE")){const m=O.split(/[:\s]+/);if(m.length>=2){const p=m[1].split("/");if(p.length===2){const se=parseFloat(p[0]),Z=parseFloat(p[1]);!Number.isNaN(se)&&!Number.isNaN(Z)&&Z!==0&&(n.measureRatio=se/Z)}}}else E.startsWith("#GOGOSTART")?(n.gogoTime=!0,n.currentBarGogoChanges.push({index:n.currentBarBuffer.length,isGogo:!0}),n.currentBarBuffer.length===0&&(J=!0)):E.startsWith("#GOGOEND")&&(n.gogoTime=!1,n.currentBarGogoChanges.push({index:n.currentBarBuffer.length,isGogo:!1}),n.currentBarBuffer.length===0&&(J=!1));continue}let P=O;for(;;){const E=P.indexOf(",");if(E===-1){n.currentBarBuffer+=P;break}else{const m=P.substring(0,E);n.currentBarBuffer+=m;const p=n.currentBarBuffer.trim();p.length===0?C.push([]):C.push(p.split("").map(ue)),v.push({bpm:Q,scroll:ee,measureRatio:n.measureRatio,gogoTime:J,isBranched:I,isBranchStart:I&&ce&&te,bpmChanges:n.currentBarBpmChanges.length>0?[...n.currentBarBpmChanges]:void 0,scrollChanges:n.currentBarScrollChanges.length>0?[...n.currentBarScrollChanges]:void 0,gogoChanges:n.currentBarGogoChanges.length>0?[...n.currentBarGogoChanges]:void 0}),te=!1,Q=n.bpm,ee=n.scroll,J=n.gogoTime,n.currentBarBpmChanges=[],n.currentBarScrollChanges=[],n.currentBarGogoChanges=[],n.currentBarBuffer="",P=P.substring(E+1)}}}};let b=[],F=[],w=[],_=[],y=!1,x="n",X=!1;for(const d of u){const C=d.toUpperCase().trim();if(C.startsWith("#BRANCHSTART")){if(X=!0,b.length>0&&(g(b,L,R,M,!1),g(b,T,k,j,!1),g(b,N,A,G,!1),b=[]),y){const v=F,n=w.length>0?w:v,I=_.length>0?_:n;g(v,L,R,M,!0,!0),g(n,T,k,j,!0,!0),g(I,N,A,G,!0,!0)}y=!0,x="n",F=[],w=[],_=[]}else if(C.startsWith("#BRANCHEND")){const v=F,n=w.length>0?w:v,I=_.length>0?_:n;g(v,L,R,M,!0,!0),g(n,T,k,j,!0,!0),g(I,N,A,G,!0,!0),y=!1,F=[],w=[],_=[]}else y&&C==="#N"?x="n":y&&C==="#E"?x="e":y&&C==="#M"?x="m":y?x==="n"?F.push(d):x==="e"?w.push(d):x==="m"&&_.push(d):b.push(d)}if(y){const d=F,C=w.length>0?w:d,v=_.length>0?_:C;g(d,L,R,M,!0,!0),g(C,T,k,j,!0,!0),g(v,N,A,G,!0,!0)}else b.length>0&&(g(b,L,R,M,!1),g(b,T,k,j,!1),g(b,N,A,G,!1));const $=(d,C,v)=>({bars:d,barParams:C,loop:_e(d),balloonCounts:Y,headers:h,title:f,subtitle:S,bpm:B,level:H,course:le,branchType:v}),V=$(L,R,"normal");X&&(V.branches={normal:V,expert:$(T,k,"expert"),master:$(N,A,"master")}),o[a]=V}return o}function _e(l){let e=-1;for(let s=0;s<l.length;s++)if(!ae(l[s])){e=s;break}if(e===-1)return;const t=l.length-e;for(let s=1;s<=t/2;s++){const r=l.slice(e,e+s);let i=0,c=e;for(;c+s<=l.length;){let o=!0;for(let a=0;a<s;a++)if(!ye(l[c+a],r[a])){o=!1;break}if(o)i++,c+=s;else break}if(i>=2){let o=!0;for(let a=c;a<l.length;a++)if(!ae(l[a])){o=!1;break}if(o)return{startBarIndex:e,period:s,iterations:i}}}}function ae(l){return l.length===0?!0:l.every(e=>e===de.None)}function ye(l,e){if(l.length!==e.length)return!1;for(let t=0;t<l.length;t++)if(l[t]!==e[t])return!1;return!0}class xe{indexUrl="ese_index.json";treeCache=null;async getTjaFiles(){if(this.treeCache)return this.treeCache;try{const e=await fetch(this.indexUrl);if(!e.ok){if(e.status===404)return console.warn("ese_index.json not found. Returning empty list."),[];throw new Error(`Failed to fetch ESE index: ${e.status} ${e.statusText}`)}let t;const s=await e.json();return Array.isArray(s)?t=s:typeof s=="object"&&s!==null&&"files"in s&&Array.isArray(s.files)?t=s.files:t=[],this.treeCache=t,t}catch(e){throw console.error("Error fetching ESE index:",e),new Error("Failed to load song list.")}}async getFileContent(e){try{const s=`ese/${e.split("/").map(encodeURIComponent).join("/")}`,r=await fetch(s);if(!r.ok)throw new Error(`Failed to fetch file: ${r.status} ${r.statusText}`);return await r.text()}catch(t){throw console.error("Error fetching file content:",t),new Error("Failed to load song content.")}}}const oe=`//TJADB Project
...
0, //123
#END
`;class Oe{eventSource=null;simulateInterval=null;onMessageCallback=null;onStatusChangeCallback=null;connect(e,t){this.disconnect();const s=`http://${e}:${t}/`;console.log(`Connecting to ${s}...`);try{this.eventSource=new EventSource(s),this.eventSource.onopen=()=>{console.log("Connected to judgement source."),this.onStatusChangeCallback&&this.onStatusChangeCallback("Connected")},this.eventSource.onmessage=r=>{try{const i=JSON.parse(r.data);this.onMessageCallback&&this.onMessageCallback(i)}catch(i){r.data&&r.data.trim()!==""&&console.error("Failed to parse event data",i,r.data)}},this.eventSource.onerror=r=>{console.error("EventSource error."),this.eventSource?.readyState===EventSource.CLOSED?this.onStatusChangeCallback&&this.onStatusChangeCallback("Disconnected"):this.onStatusChangeCallback&&this.onStatusChangeCallback("Error/Reconnecting")}}catch(r){console.error("Connection error:",r),this.onStatusChangeCallback&&this.onStatusChangeCallback("Connection Failed")}}cleanup(){let e=!1;return this.eventSource&&(this.eventSource.close(),this.eventSource=null,e=!0),this.simulateInterval&&(clearInterval(this.simulateInterval),this.simulateInterval=null,e=!0),e}disconnect(){this.cleanup()&&this.onStatusChangeCallback&&this.onStatusChangeCallback("Disconnected")}startSimulation(e,t){this.cleanup(),console.log("Starting simulation..."),this.onStatusChangeCallback&&this.onStatusChangeCallback("Connected");const s=e||oe,r=t||"oni";if(this.onMessageCallback){const h={type:"gameplay_start",tjaSummaries:[{player:1,tjaContent:s,difficulty:r}]};this.onMessageCallback(h)}const i=we(s),c=i[r]||Object.values(i)[0];if(!c){console.error("Simulation failed: Could not parse chart");return}const o=[],a={};for(const h of c.bars)for(const f of h)ie.includes(f)&&(a[f]===void 0&&(a[f]=0),o.push({type:f,ordinal:a[f]}),a[f]++);let u=0;this.simulateInterval=window.setInterval(()=>{if(u>=o.length){this.simulateInterval&&clearInterval(this.simulateInterval);return}const h=o[u];u++;const f=Math.random();let S="perfect";f<.9?S="perfect":f<.99?S="good":S="poor";const B=Math.floor(Math.random()*100)-50,H={type:"judgement",judgement:S,msDelta:B,noteChar:h.type,noteOrdinalByChar:h.ordinal};this.onMessageCallback&&this.onMessageCallback(H)},100+Math.random()*200)}onMessage(e){this.onMessageCallback=e}onStatusChange(e){this.onStatusChangeCallback=e}}const Be={parsedTJACharts:null,currentChart:null,viewOptions:{viewMode:"original",coloringMode:"categorical",visibility:{perfect:!0,good:!0,poor:!0},collapsedLoop:!1,selectedLoopIteration:void 0,beatsPerLine:16,selection:null,annotations:new z,showTextInAnnotationMode:!1,alwaysShowAnnotations:!1,autoZoom:!1},loadedTJAContent:oe,activeDataSourceMode:"list",isSimulating:!1,isStreamConnected:!1,hasReceivedGameStart:!1,selectedNoteHitInfo:null,annotations:new z,eseClient:new xe,eseTree:null,judgementClient:new Oe,judgements:new U,currentEsePath:null,currentStatusKey:"status.initializing",currentStatusParams:void 0,isTesterMode:!1};class Le extends HTMLElement{canvas;messageContainer;_chart=null;_viewOptions=null;_judgements=new U;_texts;_message=null;resizeObserver;_renderTask=null;_pendingFullRender=!0;_chartChanged=!1;_layout=null;_renderedJudgements=new U;constructor(){super(),this.attachShadow({mode:"open"}),this.resizeObserver=new ResizeObserver(()=>{this._pendingFullRender=!0,this.scheduleRender()})}connectedCallback(){this.renderDOM(),this.upgradeProperty("chart"),this.upgradeProperty("viewOptions"),this.upgradeProperty("judgements"),this.upgradeProperty("texts"),this.resizeObserver.observe(this),this.scheduleRender()}renderDOM(){const e=fe(Se,{children:[D("style",{children:`
            :host {
                display: block;
                width: 100%;
                overflow: hidden;
